...
class AdminSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = NewsSummary
        fields = ('id', 'article_id', 'article_title', 'summary_text', 'upvotes', 'downvotes', 'created_at', 'updated_at')
        read_only_fields = ('id', 'created_at', 'updated_at')
...
class AdminCommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('id', 'user_id', 'username', 'article_id', 'article_title', 'content', 'created_at', 'updated_at')
        read_only_fields = ('id', 'created_at', 'updated_at')
