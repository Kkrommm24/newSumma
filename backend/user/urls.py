...
urlpatterns = [
    ...
    path('admin/users/filter-values/', AdminUserManagementView.as_view(), name='admin-users-filter-values'),
    ...
    path('admin/articles/filter-values/', AdminArticleManagementView.as_view(), name='admin-articles-filter-values'),
    ...
    path('admin/summaries/filter-values/', AdminSummaryManagementView.as_view(), name='admin-summaries-filter-values'),
    ...
    path('admin/comments/filter-values/', AdminCommentManagementView.as_view(), name='admin-comments-filter-values'),
