...
urlpatterns = [
    path(
        'fav-words/',
        UserFavoriteKeywordsView.as_view(),
    ...
    path(
        'admin/summarize/',
        AdminSummarizeView.as_view(),
        name='admin-summarize'),
    path(
        'admin/users/',
        AdminUserManagementView.as_view(),
        name='admin-users'),
    path('admin/users/filter-values/',
         AdminUserManagementView.as_view(),
         name='admin-users-filter-values'),
    path(
    ...
    path(
        'admin/articles/',
        AdminArticleManagementView.as_view(),
        name='admin-articles'),
    path('admin/articles/filter-values/',
         AdminArticleManagementView.as_view(),
         name='admin-articles-filter-values'),
    path(
        'admin/articles/<uuid:article_id>/',
        AdminArticleManagementView.as_view(),
        name='admin-article-detail'),
    path(
        'admin/summaries/',
        AdminSummaryManagementView.as_view(),
        name='admin-summaries'),
    path('admin/summaries/filter-values/',
         AdminSummaryManagementView.as_view(),
         name='admin-summaries-filter-values'),
    path(
        'admin/summaries/<uuid:summary_id>/',
        AdminSummaryManagementView.as_view(),
        name='admin-summary-detail'),
    path(
        'admin/comments/',
        AdminCommentManagementView.as_view(),
        name='admin-comments'),
    path('admin/comments/filter-values/',
         AdminCommentManagementView.as_view(),
         name='admin-comments-filter-values'),
    path(
    ...
    path(
        'admin/fav-words/',
        AdminFavoriteWordManagementView.as_view(),
        name='admin-fav-words'),
    path(
        'admin/fav-words/<str:keyword>/',
        AdminFavoriteWordManagementView.as_view(),
        name='admin-fav-word-detail'),
]
